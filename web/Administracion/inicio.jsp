<%-- 
    Document   : inicio
    Created on : 19 may. 2023, 06:40:06
    Author     : LENOVO
--%>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th class="text-center">1</th>
                                                <th class="text-center">Masaje Thi</th>
                                                <th class="text-center">2 horas</th>
                                                <th class="text-center">Precio</th>
                                                <th class="text-center">Mañana</th>
                                                <th class="text-center">Masaje</th>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Base Datos Pagos</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
