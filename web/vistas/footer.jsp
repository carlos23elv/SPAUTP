<%-- 
    Document   : footer
    Created on : 19 may. 2023, 05:11:21
    Author     : LENOVO
--%>
...
<!-- Footer Start -->
    <div class="footer wow fadeIn" data-wow-delay="0.3s">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="footer-link">
                        ...
                        <a href="info.jsp">Sobre Nosotros</a>
                        <a href="descripcion.jsp">Empleados</a>
                        <a href="servicios.jsp">Servicios</a>
                        <a href="atencion.jsp">Atención</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="footer-link">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="newsletter">
                        ...
                        <div class="form">
                            <a href="login.jsp"><button class="btn">Regístrate</button></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container footer-menu">
            <div class="f-menu">
                <a href="servicios.jsp">Servicios</a>
                <a href="descripcion.jsp">Encargados</a>
                <a href="descripcion.jsp">Tecnicos</a>
                <a href="atencion.jsp">Contactos</a>
            </div>
        </div>
...
<!-- Footer End -->
    <a href="#" class="back-to-top"><i class="fa fa-chevron-up"></i>a</a>
